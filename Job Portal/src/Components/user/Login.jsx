...
const Submit = event =>{
    ...
    if(response.data.status===true) {     
      ...
      localStorage.setItem("phno",response.data.user_data.phone_no)
 
  if(response.data.user_data.role==='Employer')
    navigate('/employeedb/')
else
navigate('/candidatedb/')
    }
    else
   {
    setShowModel(true)
...
<div className='logcontain'>
      ...
      <img src="/src/images/jobimg.webp" className="d-inline w-20" alt="..." style={{width:"50%"}}/>
